...
// kalkulatorMFC.cpp: definiuje zachowania klasy dla aplikacji.
//
...
BEGIN_MESSAGE_MAP(CkalkulatorMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Konstrukcja klasy CkalkulatorMFCApp

CkalkulatorMFCApp::CkalkulatorMFCApp()
{
...
// Jedyny obiekt CkalkulatorMFCApp

CkalkulatorMFCApp theApp;


// Inicjowanie klasy CkalkulatorMFCApp

BOOL CkalkulatorMFCApp::InitInstance()
{
